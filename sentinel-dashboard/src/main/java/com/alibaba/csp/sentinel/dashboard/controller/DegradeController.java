...
//            List<DegradeRuleEntity> rules = sentinelApiClient.fetchDegradeRuleOfMachine(app, ip, port);
            List<DegradeRuleEntity> rules = sentinelApiClient.fetchDegradeRuleFromNacosServer(app,ip,port);
    ...
    public Result<DegradeRuleEntity> apiAddRule(@RequestBody DegradeRuleEntity entity) {
        // 先从nacos配置中心中拉取降级规则
        List<DegradeRuleEntity> degradeRuleEntities = sentinelApiClient.fetchDegradeRuleFromNacosServer(entity.getApp(),entity.getIp(),entity.getPort());
        repository.saveAll(degradeRuleEntities);
...
//        }
    ...
    private void publishRulesToNacosServer(String app, String ip, Integer port) {
        List<DegradeRuleEntity> rules = repository.findAllByMachine(MachineInfo.of(app, ip, port));
        sentinelApiClient.publishDegradeRulesToNacosServer(app, rules);
    }
